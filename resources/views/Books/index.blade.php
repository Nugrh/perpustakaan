...
{{--                    @for($i = 1; $i <= 10; $i++)--}}
                    @foreach($books as $book)
                        <tr>
                            ...
                            <td>{{ $book->stock }}</td>
                            <td>
                                <a href="./book/{{$book->id}}/edit" class="btn btn-sm btn-warning">
                                ...
                                <a href="./book/{{$book->id}}/delete" onclick="return confirm('Are you sure want to delete this book?')" class="btn btn-sm btn-danger">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
