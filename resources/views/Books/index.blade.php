    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
                <div class="row">
                <div class="col mb-2">
                    <a href="books/create" class="btn btn-primary">Tambah stock buku</a>
                    ...
                    @foreach($books as $book)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="books/{{$book->id}}/delete" onclick="return confirm('Are you sure want to delete this book?')" class="btn btn-sm btn-danger">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
